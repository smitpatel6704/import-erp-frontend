...
export function ImporterCompanyManagement() {
    ...
    return (_jsxs(motion.div, { initial: { opacity: 0, y: 8 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.3 }, className: "space-y-4", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "flex h-10 w-10 items-center justify-center rounded-xl bg-teal/10", children: _jsx(Building2, { className: "h-5 w-5 text-teal" }) }), _jsxs("div", { children: [_jsx("h3", { className: "text-lg font-semibold", children: "Importer Companies" }), _jsx("p", { className: "text-xs text-muted-foreground", children: "Manage importing companies and business partners" })] })] }), _jsx(Card, { className: "glass border-0 shadow-enterprise", children: _jsx(CardContent, { className: "p-4", children: _jsxs("div", { className: "flex flex-col sm:flex-row items-start sm:items-center gap-3", children: [_jsxs("div", { className: "relative flex-1 w-full sm:max-w-sm", children: [_jsx(Search, { className: "absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" }), _jsx(Input, { placeholder: "Search importer, GST, IEC, email...", value: searchQuery, onChange: (e) => { setSearchQuery(e.target.value); setPage(1); }, className: "pl-9 h-9 text-sm" })] }), _jsxs("div", { className: "flex items-center gap-2 ml-auto", children: [_jsxs(Badge, { variant: "secondary", className: "text-xs", children: [totalCount, " importers"] }), _jsxs(Button, { size: "sm", className: "h-9 text-xs", onClick: () => setNewCompanyOpen(true), children: [_jsx(Plus, { className: "h-3.5 w-3.5 mr-1" }), " Add Importer"] })] })] }) }) }), loading ? (_jsx(Card, { className: "glass border-0 shadow-enterprise", children: _jsx(CardContent, { className: "py-16", children: _jsx(ShippingLoader, { compact: true, label: "Loading importer companies" }) }) })) : companies.length === 0 ? (_jsxs("div", { className: "flex flex-col items-center justify-center py-20 text-muted-foreground", children: [_jsx(Building2, { className: "h-12 w-12 mb-3 opacity-30" }), _jsx("p", { className: "text-sm", children: "No importer companies found" }), _jsx("p", { className: "text-xs mt-1", children: "Try adjusting your search or add an importer company" })] })) : (_jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: companies.map((company, i) => (_jsx(motion.div, { initial: { opacity: 0, y: 12 }, animate: { opacity: 1, y: 0 }, transition: { delay: i * 0.04, duration: 0.25 }, children: _jsx(Card, { className: "glass border-0 shadow-enterprise hover-lift cursor-pointer group", onClick: () => openDetail(company.id), children: _jsxs(CardContent, { className: "p-5", children: [_jsxs("div", { className: "flex items-start gap-3 mb-4", children: [_jsx(Avatar, { className: "h-10 w-10 border border-teal/20", children: _jsx(AvatarFallback, { className: "bg-teal/10 text-teal font-semibold text-sm", children: company.name.charAt(0).toUpperCase() }) }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsx("p", { className: "text-sm font-semibold truncate group-hover:text-teal transition-colors", children: company.name }), _jsxs("div", { className: "flex items-center gap-1.5 text-[11px] text-muted-foreground mt-0.5", children: [_jsx(User, { className: "h-3 w-3" }), _jsx("span", { className: "truncate", children: company.contactPerson || 'No contact' })] })] }), _jsx(Badge, { variant: "outline", className: cn('text-[9px] font-semibold shrink-0', company.isActive
...
export default function CompaniesModule() {
    return (_jsxs(Tabs, { defaultValue: "importers", className: "space-y-4", children: [_jsxs("div", { className: "flex items-center justify-between gap-3", children: [_jsxs(TabsList, { className: "h-10", children: [_jsx(TabsTrigger, { value: "importers", className: "text-xs", children: "Importer Companies" }), _jsx(TabsTrigger, { value: "exporters", className: "text-xs", children: "Exporter Companies" })] }), _jsx(Badge, { variant: "outline", className: "hidden sm:inline-flex text-[10px] uppercase tracking-wider", children: "Operations" })] }), _jsx(TabsContent, { value: "importers", className: "mt-0", children: _jsx(ImporterCompanyManagement, {}) }), _jsx(TabsContent, { value: "exporters", className: "mt-0", children: _jsx(ExporterCompanyManagement, {}) })] }));
}

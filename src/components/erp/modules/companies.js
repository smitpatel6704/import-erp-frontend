    ...
    children: [
      _jsxs("div", {
        ...
        children: [
          _jsx("div", {
            ...
            children: _jsx(Building2, { className: "h-5 w-5 text-teal" }),
          }),
          _jsxs("div", {
            children: [
              _jsx("h3", {
                className: "text-lg font-semibold",
                children: "Importer Companies",
              }),
              _jsx("p", {
                className: "text-xs text-muted-foreground",
                children: "Manage importing companies and business partners",
              }),
            ],
          }),
        ],
            ...
            children: [
              _jsxs("div", {
                ...
                children: [
                  ...
                  _jsx(Input, {
                    placeholder: "Search importer, GST, IEC, email...",
                    value: searchQuery,
                    onChange: (e) => {
      ...
      loading
        ? _jsx(Card, {
            ...
            children: _jsx(CardContent, {
              className: "py-16",
              children: _jsx(ShippingLoader, {
                compact: true,
                label: "Loading importer companies",
              }),
            }),
          })
        : companies.length === 0
          ? _jsxs("div", {
              ...
              children: [
                _jsx(Building2, { className: "h-12 w-12 mb-3 opacity-30" }),
                _jsx("p", {
                  className: "text-sm",
                  children: "No importer companies found",
                }),
                _jsx("p", {
                  className: "text-xs mt-1",
                  children:
                    "Try adjusting your search or add an importer company",
                }),
              ],
            })
          : _jsx("div", {
              className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4",
              children: companies.map((company, i) =>
                _jsx(
                  motion.div,
                  {
                    ...
                    children: _jsx(Card, {
                      className:
                        "glass border-0 shadow-enterprise hover-lift cursor-pointer group",
                      ...
                      children: _jsxs(CardContent, {
                        ...
                        children: [
                          _jsxs("div", {
                            ...
                            children: [
                              _jsx(Avatar, {
                                className: "h-10 w-10 border border-teal/20",
                                children: _jsx(AvatarFallback, {
                                  className:
                                    "bg-teal/10 text-teal font-semibold text-sm",
                              ...
                              _jsxs("div", {
                                ...
                                children: [
                                  _jsx("p", {
                                    className:
                                      "text-sm font-semibold truncate group-hover:text-teal transition-colors",
                                    children: company.name,
                                  }),
                                  _jsxs("div", {
                                    className:
                                      "flex items-center gap-1.5 text-[11px] text-muted-foreground mt-0.5",
                                    children: [
                                      _jsx(User, { className: "h-3 w-3" }),
                                      _jsx("span", {
                                        className: "truncate",
                                        children:
                                          company.contactPerson || "No contact",
                                      }),
                                    ],
                                  }),
                                ],
                              ...
                              company.mobile &&
                                _jsxs("div", {
                                  ...
                                  children: [
                                    ...
                                    _jsx("span", { children: company.mobile }),
                                  ],
                                }),
                              company.gstNumber &&
                                _jsxs("div", {
                                  ...
                                  children: [
                                    ...
                                    _jsxs("span", {
                                      children: ["GST: ", company.gstNumber],
                                    }),
                                  ],
                                }),
                              company.iecCode &&
                                _jsxs("div", {
                                  ...
                                  children: [
                                    ...
                                    _jsxs("span", {
                                      children: ["IEC: ", company.iecCode],
                                    }),
                                  ],
                                }),
                            ],
                          }),
                          _jsx(Separator, { className: "my-3" }),
                          _jsxs("div", {
                            ...
                            children: [
                                ...
                                children: [
                                  _jsxs("div", {
                                    ...
                                    children: [
                                      ...
                                      _jsx("span", {
                                        ...
                                        children: company._count.shipments,
                                      }),
                                      _jsx("span", {
                                  ...
                                  _jsxs("div", {
                                    ...
                                    children: [
                                      _jsx(FileText, {
                                        className:
                                          "h-3.5 w-3.5 text-amber-dark",
                                      }),
                                      _jsx("span", {
                                        className: "font-medium",
                                        children: company._count.invoices,
                                      }),
                                      _jsx("span", {
                                        className: "text-muted-foreground",
                                        children: "invoices",
                              ...
                              company.creditLimit > 0 &&
                                _jsxs("span", {
                                  ...
                                  children: [
                                    "Credit: ",
                                    currencyFmt(company.creditLimit),
                                  ],
                                }),
                            ],
                          }),
          ...
          children: [
            _jsx(DialogHeader, {
              ...
              children: _jsxs("div", {
                ...
                children: [
                  _jsx(Avatar, {
                    className: "h-12 w-12 border-2 border-teal/20",
                    children: _jsx(AvatarFallback, {
                      className: "bg-teal/10 text-teal font-bold text-lg",
                      children:
                        ((_a =
                          selectedCompany === null || selectedCompany === void 0
                            ? void 0
                            : selectedCompany.name) === null || _a === void 0
                          ? void 0
                        ...
                        children: _jsxs(TabsList, {
                          ...
                          children: [
                            ...
                            _jsxs(TabsTrigger, {
                              ...
                              children: [
                                "Shipments (",
                                selectedCompany._count.shipments,
                                ")",
                              ],
                            }),
                            _jsx(TabsTrigger, {
                      ...
                      _jsxs(ScrollArea, {
                        ...
                        children: [
                                    ...
                                    _jsx("div", {
                                      ...
                                      children: [
                                        ...
                                        },
                                        {
                                          ...
                                          value: selectedCompany.officeAddress,
                                          icon: MapPin,
                                        },
                                      ].map((field) =>
                                        _jsxs(
                                          "div",
                                          {
                                            ...
                                            children: [
                                              _jsx("div", {
                                                className:
                                                  "flex h-7 w-7 items-center justify-center rounded-lg bg-teal/10 shrink-0 mt-0.5",
                                                children: _jsx(field.icon, {
                                                  className:
                                                    "h-3.5 w-3.5 text-teal",
                                                }),
                                              }),
                                              _jsxs("div", {
                                                children: [
                                ...
                                _jsxs("div", {
                                  children: [
                                    _jsx("h4", {
                                      className:
                                        "text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-3",
                                      children: "Regulatory & Tax",
                                    }),
                                    _jsx("div", {
                                      className: "grid grid-cols-2 gap-4",
                                      children: [
                                        ...(Array.isArray(selectedCompany.customFields)
                                          ? selectedCompany.customFields.map((f) => ({
                                  ...
                                  children: [
                                    ...
                                    _jsx("div", {
                                      ...
                                      children: [
                                        ...
                                        {
                                          label: "IFSC Code",
                                          value: selectedCompany.bankIfsc,
                                          icon: Hash,
                                        },
                                      ].map((field) =>
                                        _jsxs(
                                          "div",
                                          {
                                            ...
                                            children: [
                                              _jsx("div", {
                                                className:
                                                  "flex h-7 w-7 items-center justify-center rounded-lg bg-amber/10 shrink-0 mt-0.5",
                                                children: _jsx(field.icon, {
                                                  className:
                                                    "h-3.5 w-3.5 text-amber-dark",
                                                }),
                          ...
                          _jsx(TabsContent, {
                            ...
                            className: "mt-4",
                            children:
                              selectedCompany.shipments &&
                              selectedCompany.shipments.length > 0
                                ? _jsx("div", {
                                    className: "space-y-2",
                                    children: selectedCompany.shipments.map(
                                      (s) =>
                                        _jsxs(
                                          "div",
                                          {
                                ...
                                : _jsx("p", {
                                    ...
                                    children:
                                      "No shipments linked to this company",
                                  }),
                          }),
                          _jsx(TabsContent, {
                            value: "financial",
                              ...
                              children: [
                                _jsxs("div", {
                                  ...
                                  children: [
                                    _jsx(Card, {
                                      className:
                                        "glass border-0 shadow-enterprise",
                                      children: _jsxs(CardContent, {
                                        ...
                                        children: [
                                          ...
                                          _jsx("p", {
                                            className:
                                              "text-xl font-bold text-teal mt-1",
                                            children: currencyFmt(
                                              ((_b =
                                                selectedCompany.invoices) ===
                                                null || _b === void 0
                                                ? void 0
                                                : _b.reduce(
                                                    (sum, inv) =>
                                    ...
                                    _jsx(Card, {
                                      ...
                                      children: _jsxs(CardContent, {
                                        ...
                                        children: [
                                          ...
                                          _jsx("p", {
                                            className:
                                              "text-xl font-bold text-emerald-600 mt-1",
                                            children: currencyFmt(
                                              ((_c =
                                                selectedCompany.invoices) ===
                                                null || _c === void 0
                  ...
                  _jsxs("div", {
                    children: [
                      ...
                      _jsx(Input, {
                        ...
                        placeholder: "Acme Imports Pvt Ltd",
                      }),
                    ],
                  }),
                  _jsxs("div", {
                      ...
                      _jsxs("div", {
                        ...
                        children: [
                          _jsx("h4", {
                            ...
                            children: "Tax & Registration Identifiers",
                          }),
                          _jsxs(Button, {
                            type: "button",
                            variant: "outline",
                            ...
                            onClick: () => setNewForm(Object.assign(Object.assign({}, newForm), {
                              customFields: [...(newForm.customFields || []), { name: "", value: "" }]
                            })),
                            children: [_jsx(Plus, { className: "w-3 h-3 mr-1" }), "Add Identifier"]
                          }),
                        ],
                      }),
                      ...(newForm.customFields || []).map((field, idx) => 
                        _jsxs("div", {
                          key: idx,
                          ...
                          children: [
                            _jsxs("div", {
                              className: "flex-1",
                              children: [
                                _jsx(Label, { className: "text-xs", children: "Identifier Name" }),
                                _jsx(Input, {
                                  value: field.name,
                                  onChange: (e) => {
                                    const newFields = [...newForm.customFields];
                                    newFields[idx].name = e.target.value;
                                    setNewForm(Object.assign(Object.assign({}, newForm), { customFields: newFields }));
                                  },
                                  className: "h-8 text-sm mt-1",
                                  placeholder: "e.g. VAT, EIN, GST",
                                })
                              ]
                            }),
                            _jsxs("div", {
                              className: "flex-1",
                              children: [
                                _jsx(Label, { className: "text-xs", children: "Value" }),
                                _jsx(Input, {
                                  value: field.value,
                                  onChange: (e) => {
                                    const newFields = [...newForm.customFields];
                            ...
                            _jsx(Button, {
                              ...
                              variant: "ghost",
                              size: "sm",
                              className: "mt-5 h-8 px-2 text-red-600 hover:text-red-700 hover:bg-red-50",
                              onClick: () => {
                                const newFields = newForm.customFields.filter((_, i) => i !== idx);
                                setNewForm(Object.assign(Object.assign({}, newForm), { customFields: newFields }));
                              },
                              children: "Remove"
                            })
  ...
  return _jsxs(Tabs, {
    ...
    children: [
      ...
      _jsx(TabsContent, {
        value: "importers",
        className: "mt-0",
        children: _jsx(ImporterCompanyManagement, {}),
      }),
      _jsx(TabsContent, {
        value: "exporters",
        className: "mt-0",
        children: _jsx(ExporterCompanyManagement, {}),
      }),
    ],
  });
}

...
export default function ExporterCompanyManagement() {
    const canCreateCompanies = useERPStore((state) => state.canAction('companies', 'create'));
    const canDeleteCompanies = useERPStore((state) => state.canAction('companies', 'delete'));
    ...
    const handleAdd = async () => {
        ...
        try {
            ...
            const url = editingId ? `/api/exporter-companies/${editingId}` : '/api/exporter-companies';
            await fetch(url, {
                method,

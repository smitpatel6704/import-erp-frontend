...
export function ERPHeader() {
    const { activeModule, setSearchOpen, sidebarOpen, toggleSidebar, user, logout, canView, token, refreshNotificationUnreadCount } = useERPStore();
    ...
    React.useEffect(() => {
        if (!token || !canView("notifications"))
            return;

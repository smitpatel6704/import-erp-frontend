...
export function LoginPage() {
    ...
    return _jsx(AuthShell, { title: needsBootstrap ? "Create Admin Account" : "Secure sign in", description: needsBootstrap ? "Set up the first administrator account" : "Sign in with your email and password", children: passwordForm });
}
